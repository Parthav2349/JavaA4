...
public class HelloController {
    ...
    private Scene scene;
    @FXML
    void libMngSys(ActionEvent event) throws IOException{
    ...
    @FXML
    void authors(ActionEvent event) throws IOException{
    ...
    @FXML
    void bookGenres(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("bookGenres.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    @FXML
    void members(ActionEvent event) throws IOException{
